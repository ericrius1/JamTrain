...
const GIRAFFE_ROOT = '/puppets/giraffe';
...
const GIRAFFE_BODY_HEIGHT = 1.52;
...
export const ILLUSTRATED_PUPPETS: Partial<Record<CreatureId, IllustratedPuppetSpec>> = {
  ...
  giraffe: {
    name: 'Giraffe',
    body: {
      url: `${GIRAFFE_ROOT}/body.webp`,
      width: GIRAFFE_BODY_HEIGHT * (1164 / 1351),
      aspect: 1351 / 1164,
      position: [0.03, 0.89, -0.02],
      renderOrder: 10,
      color: 0xffffff,
    },
    contactShadow: {
    ...
    arms: {
      ...
      elbowBlend: 0.5,
      upper: {
        url: `${GIRAFFE_ROOT}/upper-arm.webp`,
        width: 0.17,
        aspect: 472 / 297,
        from: { x: 0.36, y: 0.15 },
        to: { x: 0.78, y: 0.84 },
      ...
      hand: {
        url: `${GIRAFFE_ROOT}/hand-cupped.webp`,
        width: 0.22,
        aspect: 252 / 260,
        from: { x: 0.26, y: 0.6 },
        to: { x: 0.9, y: 0.24 },

...
const POINTER_SPEED_RESPONSE_NDC_PER_SEC = 10;
const POINTER_GESTURE_SPEED_MAX = 0.25;
const POINTER_HIT_VELOCITY_BASE = 0.22;
const POINTER_HIT_VELOCITY_MOTION_RANGE = 0.06;
